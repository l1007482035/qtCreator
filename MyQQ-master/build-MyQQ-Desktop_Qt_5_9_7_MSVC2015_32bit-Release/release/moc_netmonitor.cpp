...
void NetMonitor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        NetMonitor *_t = static_cast<NetMonitor *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (NetMonitor::*_t)(qint32 & );
...
const QMetaObject NetMonitor::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_NetMonitor.data,
      qt_meta_data_NetMonitor,  qt_static_metacall, nullptr, nullptr}
};
