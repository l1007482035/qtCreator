...
void BigFileSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        BigFileSocket *_t = static_cast<BigFileSocket *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (BigFileSocket::*_t)(int , const QString & , const QString & );
        ...
        {
            typedef void (BigFileSocket::*_t)(int );
...
const QMetaObject BigFileSocket::staticMetaObject = {
    { &QTcpSocket::staticMetaObject, qt_meta_stringdata_BigFileSocket.data,
      qt_meta_data_BigFileSocket,  qt_static_metacall, nullptr, nullptr}
};
