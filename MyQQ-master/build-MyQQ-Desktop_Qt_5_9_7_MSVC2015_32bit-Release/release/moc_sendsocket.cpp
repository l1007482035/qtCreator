...
void SendSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SendSocket *_t = static_cast<SendSocket *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (SendSocket::*_t)(int , QString );
...
const QMetaObject SendSocket::staticMetaObject = {
    { &QTcpSocket::staticMetaObject, qt_meta_stringdata_SendSocket.data,
      qt_meta_data_SendSocket,  qt_static_metacall, nullptr, nullptr}
};
