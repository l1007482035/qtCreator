...
void RegisterSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        RegisterSocket *_t = static_cast<RegisterSocket *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (RegisterSocket::*_t)();
...
const QMetaObject RegisterSocket::staticMetaObject = {
    { &QTcpSocket::staticMetaObject, qt_meta_stringdata_RegisterSocket.data,
      qt_meta_data_RegisterSocket,  qt_static_metacall, nullptr, nullptr}
};
