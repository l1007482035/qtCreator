...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ImageHelper *_t = static_cast<ImageHelper *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject ImageHelper::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ImageHelper.data,
      qt_meta_data_ImageHelper,  qt_static_metacall, nullptr, nullptr}
};
